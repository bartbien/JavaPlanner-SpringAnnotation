...
public class ExportController
{
	...
	public ModelAndView scheduler_16(HttpServletRequest request) throws Exception
	{
		...
		mnv.addObject(
				"sample_dsc",
				"To provide printing capabilities, scheduler supports export to a PDF document. Also, there is support for data export to the iCal format that allows you to share the JavaPlanner data across different apps and devices.");
	...
	@ResponseBody
	public String events_16(HttpServletRequest request)
	{
	...
	@ResponseBody
	public String ical_16(HttpServletRequest request, HttpServletResponse response)
	{

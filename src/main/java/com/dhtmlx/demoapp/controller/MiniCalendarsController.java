...
public class MiniCalendarsController
{
	...
	public ModelAndView scheduler_12(HttpServletRequest request) throws Exception
	{
		...
		mnv.addObject(
				"sample_dsc",
				"To simplify navigation, you can display a small date picker on the left side of the JavaPlanner header. Also, you can put a date picker in the lightbox or any HTML container outside the JavaPlaner.");
	...
	@ResponseBody
	public String events_12(HttpServletRequest request)
	{

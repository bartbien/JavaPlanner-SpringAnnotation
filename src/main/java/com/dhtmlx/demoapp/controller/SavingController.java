...
public class SavingController
{
	...
	public ModelAndView scheduler_03(HttpServletRequest request) throws Exception
	{
		...
		mnv.addObject("sample_dsc",
				"JavaPlanner provides simple integration with the server side. Add, edit, delete events and then, reload the page. All the changes will be saved.");
	...
	@ResponseBody
	public String events_03(HttpServletRequest request)
	{

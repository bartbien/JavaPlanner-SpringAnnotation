...
public class HighlightsController
{
	...
	public ModelAndView scheduler_13(HttpServletRequest request) throws Exception
	{
		...
		mnv.addObject(
				"sample_dsc",
				"You may highlight specific blocks in the JavaPlanner (periods of particular importance) with any CSS style. Also, there is the possibility to highlight the area under the mouse pointer.");
	...
	@ResponseBody
	public String events_13(HttpServletRequest request)
	{

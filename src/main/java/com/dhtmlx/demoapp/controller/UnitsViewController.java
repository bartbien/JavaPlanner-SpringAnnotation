...
public class UnitsViewController
{
	...
	public ModelAndView scheduler_08(HttpServletRequest request) throws Exception
	{
		...
		mnv.addObject(
				"sample_dsc",
				"Units View lets you display several calendars for multiple resources simultaneously (e.g. human resources, rooms, etc.). The calendars are arranged in columns, so you can see all of them on one page.");
	...
	@ResponseBody
	public String events_08(HttpServletRequest request)
	{

...
public class LoadingController
{
	...
	public ModelAndView scheduler_02(HttpServletRequest request) throws Exception
	{
		...
		mnv.addObject("sample_dsc",
				"JavaPlanner can load data of ICal, JSON, XML formats from a file or object. There is support for static and dynamic loading modes.");
	...
	@ResponseBody
	public String events_02(HttpServletRequest request)
	{

...
public class CustomLightboxController
{
	...
	public ModelAndView scheduler_11(HttpServletRequest request) throws Exception
	{
		...
		mnv.addObject(
				"sample_dsc",
				"There is the possibility to create a fully custom lightbox. Double click on any empty cell or event in the JavaPlanner and open lightbox that is fully custom and contains regular HTML inputs.");
	...
	@ResponseBody
	public String events_11(HttpServletRequest request)
	{

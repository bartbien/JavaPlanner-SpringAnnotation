...
public class SecurityController
{
	...
	public ModelAndView scheduler_15(HttpServletRequest request) throws Exception
	{
		...
		mnv.addObject(
				"sample_dsc",
				"By default, any user can edit data in the JavaPlanner and the related changes will be saved in the database. Built-in security manager will let you limit access to 'read', 'insert', 'update' and 'delete' operations for specific groups of users.");
	...
	@ResponseBody
	public String events_15(HttpServletRequest request)
	{

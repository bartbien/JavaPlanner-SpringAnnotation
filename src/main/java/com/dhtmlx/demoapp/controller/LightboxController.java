...
public class LightboxController
{
	...
	public ModelAndView scheduler_10(HttpServletRequest request) throws Exception
	{
		...
		mnv.addObject(
				"sample_dsc",
				"Lightbox is an editor of JavaPlanner's events. To open lightbox, double click on any cell in the JavaPlanner. Lighbox can contain any number of controls (by default, a text field for the event description and selects for setting the event duration).");
	...
	@ResponseBody
	public String events_10(HttpServletRequest request)
	{

...
public class SimpleInitController
{
	...
	public ModelAndView scheduler_01(HttpServletRequest request) throws Exception
	{
		...
		mnv.addObject("sample_dsc",
				"Basic JavaPlanner has 3 default views: Day, Week, Month. You can add, edit, delete events but when you reload the page all changes will be lost.");
